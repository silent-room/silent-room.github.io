...
## Firefox MCP — DO NOT USE

Do not start, restart, navigate, or interact with Firefox under any circumstances.
User's laptop is old; spawning Firefox instances overwhelms it.
Use the headless Chromium browser tool for verification instead, or ask the user.
